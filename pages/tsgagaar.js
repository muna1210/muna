...
<body class="w-full h-screen flex items-center justify-center bg-black">
    <div class="w-[98%] h-[96%] flex justify-between items-end">
        <div class="w-24 h-full bg-slate-900 rounded-3xl flex flex-col items-center">
            <div class="w-12 h-12 rounded-full bg-slate-800 mt-4 flex items-center justify-center">
                <Image src="https://cdn-icons-png.flaticon.com/512/3944/3944594.png" class="w-8"/>
            </div>
            <div class="w-full h-1/2 mt-8 flex flex-col items-center">
                ...
                <div class="w-24 h-24 flex flex-col items-center justify-center">
                    ...
                    <h1 class="text-slate-600 text-md">Map</h1>
                </div>
                <div class="w-24 h-24 flex flex-col items-center justify-center">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"
                        class="w-12 fill-slate-600">
                    ...
                    <h1 class="text-slate-600 text-md">Settings</h1>
                </div>
            </div>
        </div>
        <div class="w-2/3 h-full rounded-3xl">
            <div class="w-full h-16 bg-slate-900 rounded-3xl flex items-center">
            ...
            <div class="w-full h-64 bg-slate-900 rounded-3xl flex items-end justify-center relative">
                ...
                <div class="w-11/12 h-2/3 mb-8 grid grid-cols-6">
                    <div class="flex flex-col items-center">
                        ...
                        <Image src="https://freesvg.org/img/weather-overcast.png" class="mt-4 w-2/3"/>
            ...
            <div class="w-full h-60 bg-slate-900 rounded-3xl mt-4 relative flex flex-col justify-end">
                <h1 class="text-slate-400 absolute left-8 font-semibold top-4">AIR CONDITIONS</h1>
                <div
                    class="bg-blue-500 text-white rounded-full h-8 w-24 items-center flex justify-center absolute top-4 right-8">
                    See More</div>
            ...
            <div class="w-full h-[90%]">
                <div class="w-full h-[12.8%] flex items-center justify-evenly">
                    ...
                    <div class="w-1/3 h-full flex items-center justify-evenly">
                        <Imag src="https://static-00.iconduck.com/assets.00/sun-symbol-emoji-2048x2048-wityey4r.png"
                            class="w-12"/>
                ...
                <div class="w-full h-[12.8%] flex items-center justify-evenly">
                    ...
                    <div class="w-1/3 h-full flex items-center justify-evenly">
                        <Image src="https://cdn-icons-png.flaticon.com/512/4834/4834559.png" class="w-12"/>
                ...
                <div class="w-full h-[12.8%] flex items-center justify-evenly">
                    ...
                    <div class="w-1/3 h-full flex items-center justify-evenly">
                        <Image src="https://cdn-icons-png.flaticon.com/512/1566/1566424.png" class="w-12"/>
